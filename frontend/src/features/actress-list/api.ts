...
import type { ActressListParams, ActressListResponse } from "./types";
 ...
 * 女優一覧データを取得する
 */
export async function getActressList(
  params: ActressListParams = {},
): Promise<ActressListResponse | null> {
  try {
